	...
	<body>
		<div id="wrapper">
			...
			<nav>
				<div id="nav">
					<ul>
				<li><a href="http://localhost/91/indexs.php">Browse our best appetizers to get your party started</a></li>
						<li><a href="#"></a></li>
						<li><a href="#"></a></li>
			...
			<div id="content_wrapper">
				<div id="content">
					<article>
						<h2>ITEMS ARE</h2>
						<p>chicken ball (4 pcs - 150taka ) </p>
						<p>Chicken Grill(1 pcs - 110taka ) </p>
						<p>Tanduri Ruti(200 taka ) </p>
						<p>Fish Finger(200 taka) </p>
						<p>Chicken Sub  (200taka ) </p>
					</article>
				</div>
				<div id="sidebar">
