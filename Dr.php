	...
	<body>
		<div id="wrapper">
			...
			<nav>
				<div id="nav">
					<ul>
				<li><a href="http://localhost/91/indexs.php">Escape Your Tiredness</a></li>
						<li><a href="#"></a></li>
						<li><a href="#"></a></li>
			...
			<div id="content_wrapper">
				<div id="content">
					<article>
						<h2>ITEMS ARE</h2>
						<p>Regular drinks (20taka ) </p>
						<p>Coffee  (80taka) </p>
						<p>Lassi (100taka) </p>
						<p>Faluda (200taka ) </p>
						<p>Cold Coffee (110taka ) </p>
						<p>Cappuccino (200taka ) </p>
						<p>Milk Shake(250taka ) </p>
					</article>
				</div>
				<div id="sidebar">
