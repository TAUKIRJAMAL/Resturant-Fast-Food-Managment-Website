	...
	<body>
		<div id="wrapper">
			...
			<nav>
				<div id="nav">
					<ul>
				<li><a href="http://localhost/91/indexs.php">Nothing beats a warming bowl of soup</a></li>
						<li><a href="#"></a></li>
						<li><a href="#"></a></li>
			...
			<div id="content_wrapper">
				<div id="content">
					<article>
						<h2>ITEMS ARE</h2>
						<p>Thai Soup   (4:1)- 350taka  </p>
						<p>Chicken Soup (4:1)- 400taka  </p>
						<p>Chicken corn Soup (3:1)- 350taka  </p>
						<p>Special Prawn Soup (3:1)- 400taka  </p>
						<p>Special Mashroom Soup (2:1)- 400taka </p>
					</article>
				</div>
				<div id="sidebar">
